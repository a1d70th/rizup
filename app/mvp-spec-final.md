...
| 7 | 未反応通知 | 6時間以上リアクション0の投稿をRizupが通知で促す | 無料 |
...
| 13 | 月間MVP | 全スコア総合点でRizupが自動選出。プロフィールに表示 | 無料 |
...
| # | 機能 | 仕様 | プラン |
|---|---|---|---|
| 20 | 毎朝の励まし通知 | 毎朝7:00にRizupからプッシュ通知。日替わりメッセージ | 無料 |
| 21 | 週1コンテンツ | 幸福論・思考法の記事。日曜18:00に配信 | 無料 |
| 22 | メンバー限定メッセージ | Rizupからの特別メッセージ。月1〜2回 | Premium |
...
| # | 機能 | 仕様 | プラン |
|---|---|---|---|
| 24 | Rizup のおすすめ | 本・映画・場所・言葉。Rizupが厳選して投稿 | 無料 |
...
| プラン | 月額 | 機能 |
|---|---|---|
| **無料** | ¥0 | 投稿・タイムライン・リアクション・ランキング閲覧・Rizupの朝通知・おすすめ閲覧 |
...
| `/functions/v1/generate-morning` | POST | Rizupの朝メッセージを30日分一括生成 |
