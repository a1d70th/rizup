...
- リスト形式（最大5件）
- 毎朝のSho Insightに「今日の行動がこのアンチビジョンから遠ざける一歩になる」と絡める

### 4-5. `/habits`（習慣トラッカー）

- 最大5つ → **最大10個まで拡張**
- 新規作成時にビジョンを選択（任意）
- チェック時にShoジャンプアニメ＋streak更新
...
- Pro（¥780/月）：AIフィードバック・Sho Insight・成長グラフ全指標・習慣/ビジョン無制限・アンチビジョン・ポジティブ度分析
...
3. **チェックした瞬間にShoが喜ぶアニメーション**（`animate-sho-bounce`）
